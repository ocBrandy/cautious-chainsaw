...
clean-Core-2f-Src-2f-User:
	-$(RM) ./Core/Src/User/Fpga.cyclo ./Core/Src/User/Fpga.d ./Core/Src/User/Fpga.o ./Core/Src/User/Fpga.su ./Core/Src/User/Gpio.cyclo ./Core/Src/User/Gpio.d ./Core/Src/User/Gpio.o ./Core/Src/User/Gpio.su ./Core/Src/User/Init.cyclo ./Core/Src/User/Init.d ./Core/Src/User/Init.o ./Core/Src/User/Init.su ./Core/Src/User/Passthrough.cyclo ./Core/Src/User/Passthrough.d ./Core/Src/User/Passthrough.o ./Core/Src/User/Passthrough.su ./Core/Src/User/Tim.cyclo ./Core/Src/User/Tim.d ./Core/Src/User/Tim.o ./Core/Src/User/Tim.su ./Core/Src/User/Usart.cyclo ./Core/Src/User/Usart.d ./Core/Src/User/Usart.o ./Core/Src/User/Usart.su ./Core/Src/User/main.cyclo ./Core/Src/User/main.d ./Core/Src/User/main.o ./Core/Src/User/main.su
