...
*********************************************************************************************************
*
*	模块名称 : SPI Flash的Fat文件系统演示模块及其模拟U盘功能。
*	文件名称 : demo_sdio_fatfs.c
*	版    本 : V1.2
*	说    明 : 该例程移植FatFS文件系统（版本 R0.10），演示如何创建文件、读取文件、创建目录和删除文件
*			并测试了文件读写速度以及SPI Flash模拟U盘功能
*
*	修改记录 :
*		版本号   日期        作者     说明
*
...
static void DispMenu(void)
{
	...
	printf("2 - 创建一个新文件Test1.txt\r\n");
	printf("3 - 读Test1.txt文件的内容\r\n");
	printf("4 - 创建目录\r\n");
	printf("5 - 删除文件和目录\r\n");
	printf("6 - 读写文件速度测试\r\n");
	printf("7 - 移除U盘\r\n");
...
static void CreateNewFile(void)
{
	...
	if (result == FR_OK)
	{
		printf("Test1.txt 文件写入成功\r\n");
	}
	else
	{
		printf("Test1.txt 文件写入失败\r\n");
	}
...
*********************************************************************************************************
*	函 数 名: ReadFileData
*	功能说明: 读取文件Test1.txt前128个字符，并打印到串口
*	形    参：无
*	返 回 值: 无
*********************************************************************************************************
*/
...
*********************************************************************************************************
*	函 数 名: DeleteDirFile
*	功能说明: 删除SD卡根目录下的 FatfsTest.txt 文件和 Dir1，Dir2 目录
*	形    参：无
*	返 回 值: 无
*********************************************************************************************************
*/
static void DeleteDirFile(void)
{
	...
	{
		printf("删除子目录/Dir1/Dir1_1失败(错误代码 = %s) \r\n", FR_Table[result]);
	}
...
static void GetFreeSize(void)
{
	...
	{
		tot_sect =(p->n_fatent - 2) * p->csize;		/* 获取总扇区数 */
		fre_sect = fre_clust * p->csize;			/* 剩余扇区数量 */
